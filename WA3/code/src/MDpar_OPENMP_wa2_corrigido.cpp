...
/*
##############################################################################################################################################
OTIMIZAÇAO COM OpenMP
##############################################################################################################################################
*/

// Function to calculate the potential energy of the system
/*
In this code, the private(j, k, r2, diferenca, quot, term1, term2) clause ensures that each thread has its own private copy of these variables, 
and the reduction(+:Pot) clause ensures that the Pot variable is correctly summed across all threads.
...
/*
##############################################################################################################################################
OTIMIZAÇAO COM OpenMP v2
Junção de Potential() com computeAccelerations()
##############################################################################################################################################
*/
